...
{
	std::string no_effect_fs_path = sora::Filesystem::GetAppPath("assets/shader/no_effect.fs");
	std::string no_effect_vs_path = sora::Filesystem::GetAppPath("assets/shader/no_effect.vs");
...
{
	std::string fs_path = sora::Filesystem::GetAppPath("assets/shader/emboss.fs");
	std::string vs_path = sora::Filesystem::GetAppPath("assets/shader/emboss.vs");
	sora::ReadonlyCFile fs_file = sora::ReadonlyCFile(fs_path);
	sora::ReadonlyCFile vs_file = sora::ReadonlyCFile(vs_path);
	if(!fs_file.Open()) {
		return false;
...
{
	std::string fs_path = sora::Filesystem::GetAppPath("assets/shader/edge_detection.fs");
	std::string vs_path = sora::Filesystem::GetAppPath("assets/shader/edge_detection.vs");
	sora::ReadonlyCFile fs_file = sora::ReadonlyCFile(fs_path);
	sora::ReadonlyCFile vs_file = sora::ReadonlyCFile(vs_path);
	if(!fs_file.Open()) {
		return false;
