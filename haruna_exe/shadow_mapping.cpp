...
bool ShadowMapping::InitSimpleShader()
{
	...
	return InitShader("assets/shader/simple_red.vs", "assets/shader/simple_red.fs", simple_prog_);
}
bool ShadowMapping::InitShaderMapShader()
{
	return InitShader("assets/shader/shadow_map.vs", "assets/shader/shadow_map.fs", shadow_map_prog_);
}
