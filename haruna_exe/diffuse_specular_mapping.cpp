...
{
	//쉐이더 
	std::string fs_path = sora::Filesystem::GetAppPath("assets/shader/diffuse_specular_map.fs");
	std::string vs_path = sora::Filesystem::GetAppPath("assets/shader/diffuse_specular_map.vs");
